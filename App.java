public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("The sum of 10 and 30 is " + App.computeSum( 10, 30));
        System.out.println("The sum of 10 and 30 and 90 is " + App.computeSum (10, 30, 90));

        /**
         * Call the greaterValue method with integer parameters
         */
        System.out.println("The greater value between 50 and 150 is " + greaterValue(50,150));
